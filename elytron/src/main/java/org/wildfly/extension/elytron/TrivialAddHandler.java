...
abstract class TrivialAddHandler<T> extends BaseAddHandler {
    ...
    protected final void performRuntime(OperationContext context, ModelNode operation, Resource resource)
        ...
        Logger.getAnonymousLogger().info("NAME=" + runtimeCapability.getCapabilityServiceName().getCanonicalName() );
        Logger.getAnonymousLogger().info(" Operation: " + operation + " config="+adminOnlyInitialMode);
