...
public class ConsoleAvailabilityUnitTestCase {
    ...
    public void setupController() throws InterruptedException {
        ...
        ConsoleAvailabilityController caService = new ConsoleAvailabilityController(controlledProcessState, caSupplier);
    ...
    class ConsoleAvailabilityController extends TestModelControllerService {

        ConsoleAvailabilityController(ControlledProcessState controlledProcessState, Supplier<ConsoleAvailability> consoleAvailabilitySupplier) {
