...
public interface ServerInventory {
     ...
     *
     * @return Returns {@code true} if the server was selected to be restarted, otherwise it returns false.
     */
    boolean reconnectServer(String serverName, ModelNode domainModel, String authKey, boolean running, boolean stopping, boolean blockUntilStopped, boolean requestRestart, boolean restartBlocking);
