...
//    OperationFailedException deprecatedAndCurrentParameterMismatch(String deprecated, String current);
    ...
    @Message(id = 220, value = "Fail to synchronize server status upon a Host Controller registration. There is no handler associated to manage the operation %s for the server %s.")
