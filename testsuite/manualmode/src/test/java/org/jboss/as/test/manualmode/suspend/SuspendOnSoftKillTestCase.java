...
public class SuspendOnSoftKillTestCase {
    ...
    private void startContainer(int suspendTimeout) throws Exception {
        ...
        war.addAsResource(new StringAsset("Dependencies: org.jboss.dmr, org.jboss.as.controller, io.undertow.core, org.jboss.as.server,org.wildfly.extension.request-controller, org.jboss.as.network, org.jboss.xnio, org.wildfly.extension.io\n"), "META-INF/MANIFEST.MF");
